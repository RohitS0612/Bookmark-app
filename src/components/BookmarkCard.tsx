...
export default function BookmarkCard({ 
  ...
  const handleDelete = async () => {
    setDeleting(true)
    const deleteToast = toast.loading('Deleting bookmark...')
    ...
    try {
      ...
      toast.success('Bookmark deleted!', { id: deleteToast })
    } catch (error: any) {
      console.error('Error deleting bookmark:', error)
      toast.error('Failed to delete bookmark.', { id: deleteToast })
    } finally {
      setDeleting(false)
  ...
  const handleToggleFavorite = async (e: React.MouseEvent) => {
    e.stopPropagation()
    setFavoriting(true)
    const prevFavorite = bookmark.is_favorite
    ...
    try {
      ...
      toast.success(prevFavorite ? 'Removed from favorites' : 'Added to favorites')
    } catch (error: any) {
